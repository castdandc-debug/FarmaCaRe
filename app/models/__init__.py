...
from app import db  # ✅ Importa db desde app, no crea uno nuevo

class Usuario(db.Model, UserMixin):
    id = db.Column(db.Integer, primary_key=True)
    nombre = db.Column(db.String(100), unique=True, nullable=False)
    rol = db.Column(db.String(20), nullable=False, default='Caja')
    contraseña = db.Column(db.String(200), nullable=False)  # ✅ Conservado
...
# ✅ Todos tus modelos conservados tal como los creaste
class Medicamento(db.Model):
    ...
    grupo = db.Column(db.String(20))  # I, II, III, IV, V, IV-Antibiótico
...
class NoHay(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    nombre = db.Column(db.String(100), nullable=False)
    tipo = db.Column(db.String(50))  # Poco inventario, No tiene proveedor, Descontinuado, No existe
...
class Entrada(db.Model):
    ...
    producto_tipo = db.Column(db.String(20))  # 'Medicamento' o 'Dispositivo'
